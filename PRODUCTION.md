...
- Slayt prodüksiyonu Bölüm 01-09'da tamamlandı, video render henüz hiçbirinde yapılmadı. Bölüm 10, 11 ve 12'nin tamamının görselleri üretildi (kullanıcı tarafından, bu oturumun dışında); bağımsız QA'da (2026-07-17/18) Bölüm 10'da 5/7, Bölüm 11'de 5/7, Bölüm 12'de 6/8 sahne onaylanıp README'ye gömüldü — kalan sahneler (Bölüm 10: hero + scene-06; Bölüm 11: scene-06 + scene-07; Bölüm 12: hero + scene-07) kusurlu bulunup DÜZELTİLMEDEN bırakıldı — ayrıntılar aşağıda ve `visual-system/lessons-learned.md`'de.
...
- Bölüm 10 ve 11'in 7/7 görseli üretildikten SONRA (2026-07-17, bu oturumun dışında, kullanıcı+ChatGPT ile) bağımsız bir görsel QA turu yapıldı — metin QA'sının bulduğu hatalardan tamamen ayrı, yeni 4 gerçek görsel-üretim hatası bulundu: Bölüm 10 hero'sunda yazım hatası ("Aynıı veri"); Bölüm 10 scene-06'da iki cihaz etiketi hem bozuk yazılmış hem gerçek parça numarasından farklı ("24LC2S6"→AT24C256 olmalı, "BME2BO"→BMP280 olmalı); Bölüm 11 scene-06'da prompt'ta istenmeyen bir kablo şeması eklenip var olmayan bir "NRST" sinyali CN4'ün pini gibi gösterilmiş; Bölüm 11 scene-07'de CN4'ün DIO/DCLK pinleri yer değiştirmiş (bu projede tekrarlayan bilinen bir hata türü, bkz. CLAUDE.md "Bilinen görsel-üretim riskleri"). Dördü de kullanıcı onayı olmadan düzeltilmedi, `scenes.json`'da "KUSURLU" işaretlendi. Ders: metin (README/brief/scenes.json) doğru olsa bile, görsel üretim AYRI bir hata kaynağı — ikisi de bağımsız olarak doğrulanmalı.
- Bölüm 12'nin 8/8 görseli üzerinde de aynı bağımsız görsel QA turu yapıldı (2026-07-18) — 2 YENİ hata bulundu, ikisi de CN4/SWD ile ilgili: hero'da CN4 sadece 3 pin çiziyor (GND yok, DIO/DCLK ikisi de "DCIO" diye bozuk yazılmış); scene-07'de "SWD debug hazır" ikonu genel bir 10-pinli ARM header çizip var olmayan bir "NRST" sinyali eklemiş — bu TAM OLARAK Bölüm 11 scene-06'daki hatanın bir başka bölümde tekrarı. Önemli: bu bölümün KENDİ scene-06'sı CN4'ü doğru çiziyor (4 pin, doğru sıra) — yani aynı bölüm içinde bile bir sahne doğru, bir başkası yanlış olabiliyor; "bir sahnede doğru çıktı" bilgisi otomatik olarak diğer sahnelere yayılmıyor.
