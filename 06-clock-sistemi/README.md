...
![Clock Sistemi — Gün 06 özet görseli](hero.png)
...
![İki Kristal, İki Farklı Amaç — X1 Ana Clock, X2 RTC](slides/02-iki-kristal.png)
...
![Yük Kapasitörleri Neden Var? — X1: C13/C14, X2: C9/C12](slides/03-yuk-kapasitorleri.png)
...
![STM32 Clock Kaynakları — Yüksek Hızlı, PLL, Düşük Hızlı](slides/04-clock-kaynaklari.png)
...
![Blue Pill'de Clock Nasıl Akıyor? — 8 MHz'den 72 MHz'e](slides/05-clock-akisi.png)
...
![Sahada Ne Anlama Gelir? — Kart Açılmıyor, RTC Kayıyor](slides/06-sahada-ne-anlama-gelir.png)
